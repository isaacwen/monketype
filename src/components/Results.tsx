...
function Results(
  {state, errors, accuracyPercentage, total, className}:
  ...
  return (
    ...
    >
      ...
      <motion.li initial = {initial} animate = {animate} transition = {{...duration, delay: 1.0}} className="text-red-500">Errors: {errors}</motion.li>
